...
"""Defining the base model class representing alll classes."""
import json
import csv
import turtle
...
class Base:
    """Attributes:
        __nb_objects (int): represents the number of instantiated Bases.
    """
    ...
    def __init__(self, id=None):
        ...
        Args:
            id (int): represents the identity of the new Base.
        """
        if id is not None:
            self.id = id
        else:
